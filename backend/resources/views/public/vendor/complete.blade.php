...
<div class="q3-sf-centre">
    <div class="q3-sf-panel">
        ...
        <p>
            Your order for <strong>{{ $lead->quantity }} × {{ $lead->productName() }}</strong> is placed.
            {{ $vendor['name'] }} will confirm by email and arrange delivery.
        </p>
        ...
        <div class="q3-sf-steps">
            ...
            <ol>
                ...
                @if ($lead->stripe_receipt_url)
                    <li><a href="{{ $lead->stripe_receipt_url }}" target="_blank" rel="noopener">View your receipt</a></li>
                @endif
